...
<style>
    ...
    div[data-testid="stMetricValue"] {
        color: #6366F1 !important; /* Color Morado / Violeta estilo Alan */
...
# Usamos el SVG/PNG oficial de Alan vía URL pública para evitar errores de archivo local
logo_url = "https://upload.wikimedia.org/wikipedia/commons/4/4b/Alan_logo.png"
...
with col_logo:
    try:
        ...
        st.write("💜 **Alan**") # Fallback en texto por si falla la red
...
col2.metric("Loss Ratio Incurrido", f"{loss_ratio:.1%}", delta="Target <78%", delta_color="inverse")
...
col4.metric("Resultado Técnico Neto", f"{resultado_tecnico_neto:,.0f} €")
...
with col_left:
    st.subheader("📊 Desglose de P&L Actuarial")
    ...
    # Colores con temática Alan (Morado / Rosados / Verde para positivo)
...
with col_right:
    st.subheader("📈 Combined Ratio vs Adopción Preventiva")
